class EventsController < ApplicationController
	...
	def new
		@event = Event.create(name: params[:name], description: params[:description], location: params[:location], start_time: params[:start_time], end_time: params[:end_time], image: params[:image], user: current_user)
